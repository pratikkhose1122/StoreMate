...
mixin _$SaleItemModel {
 ...
 String get id; String get saleId; String? get productId; String get productName;@DecimalConverter() Decimal get quantity;@DecimalConverter() Decimal get unitPrice;@DecimalConverter() Decimal get taxPercentage;@DecimalConverter() Decimal get subtotal;
...
@useResult
$Res call({
 String id, String saleId, String? productId, String productName,@DecimalConverter() Decimal quantity,@DecimalConverter() Decimal unitPrice,@DecimalConverter() Decimal taxPercentage,@DecimalConverter() Decimal subtotal
});
...
as Decimal,taxPercentage: null == taxPercentage ? _self.taxPercentage : taxPercentage // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String saleId,  String? productId,  String productName, @DecimalConverter()  Decimal quantity, @DecimalConverter()  Decimal unitPrice, @DecimalConverter()  Decimal taxPercentage, @DecimalConverter()  Decimal subtotal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleItemModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String saleId,  String? productId,  String productName, @DecimalConverter()  Decimal quantity, @DecimalConverter()  Decimal unitPrice, @DecimalConverter()  Decimal taxPercentage, @DecimalConverter()  Decimal subtotal)  $default,) {final _that = this;
switch (_that) {
case _SaleItemModel():
return $default(_that.id,_that.saleId,_that.productId,_that.productName,_that.quantity,_that.unitPrice,_that.taxPercentage,_that.subtotal);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String saleId,  String? productId,  String productName, @DecimalConverter()  Decimal quantity, @DecimalConverter()  Decimal unitPrice, @DecimalConverter()  Decimal taxPercentage, @DecimalConverter()  Decimal subtotal)?  $default,) {final _that = this;
switch (_that) {
case _SaleItemModel() when $default != null:
return $default(_that.id,_that.saleId,_that.productId,_that.productName,_that.quantity,_that.unitPrice,_that.taxPercentage,_that.subtotal);case _:
  return null;
...
class _SaleItemModel implements SaleItemModel {
  const _SaleItemModel({required this.id, required this.saleId, this.productId, required this.productName, @DecimalConverter() required this.quantity, @DecimalConverter() required this.unitPrice, @DecimalConverter() required this.taxPercentage, @DecimalConverter() required this.subtotal});
...
mixin _$PaymentModel {
 ...
 String get id; String get saleId;@DecimalConverter() Decimal get amount; String get paymentMethod; String get status; String? get transactionId;
...
@useResult
$Res call({
 String id, String saleId,@DecimalConverter() Decimal amount, String paymentMethod, String status, String? transactionId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String saleId, @DecimalConverter()  Decimal amount,  String paymentMethod,  String status,  String? transactionId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String saleId, @DecimalConverter()  Decimal amount,  String paymentMethod,  String status,  String? transactionId)  $default,) {final _that = this;
switch (_that) {
case _PaymentModel():
return $default(_that.id,_that.saleId,_that.amount,_that.paymentMethod,_that.status,_that.transactionId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String saleId, @DecimalConverter()  Decimal amount,  String paymentMethod,  String status,  String? transactionId)?  $default,) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
return $default(_that.id,_that.saleId,_that.amount,_that.paymentMethod,_that.status,_that.transactionId);case _:
  return null;
...
class _PaymentModel implements PaymentModel {
  const _PaymentModel({required this.id, required this.saleId, @DecimalConverter() required this.amount, required this.paymentMethod, required this.status, this.transactionId});
...
mixin _$SaleModel {
 ...
 String get id; String get shopId; String? get customerId; CustomerModel? get customer; String get invoiceNumber; String get status;@DecimalConverter() Decimal get totalAmount;@DecimalConverter() Decimal get discountAmount;@DecimalConverter() Decimal get taxAmount;@DecimalConverter() Decimal get netAmount;@DecimalConverter() Decimal get amountPaid;@DecimalConverter() Decimal get amountDue;@DecimalConverter() Decimal? get refundAmount; DateTime? get lastRefundAt; String? get shopNameSnapshot; String? get shopAddressSnapshot; String? get shopPhoneSnapshot; List<SaleItemModel> get items; List<PaymentModel> get payments; DateTime? get createdAt;
...
@useResult
$Res call({
 String id, String shopId, String? customerId, CustomerModel? customer, String invoiceNumber, String status,@DecimalConverter() Decimal totalAmount,@DecimalConverter() Decimal discountAmount,@DecimalConverter() Decimal taxAmount,@DecimalConverter() Decimal netAmount,@DecimalConverter() Decimal amountPaid,@DecimalConverter() Decimal amountDue,@DecimalConverter() Decimal? refundAmount, DateTime? lastRefundAt, String? shopNameSnapshot, String? shopAddressSnapshot, String? shopPhoneSnapshot, List<SaleItemModel> items, List<PaymentModel> payments, DateTime? createdAt
});
...
/// Create a copy of SaleModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? shopId = null,Object? customerId = freezed,Object? customer = freezed,Object? invoiceNumber = null,Object? status = null,Object? totalAmount = null,Object? discountAmount = null,Object? taxAmount = null,Object? netAmount = null,Object? amountPaid = null,Object? amountDue = null,Object? refundAmount = freezed,Object? lastRefundAt = freezed,Object? shopNameSnapshot = freezed,Object? shopAddressSnapshot = freezed,Object? shopPhoneSnapshot = freezed,Object? items = null,Object? payments = null,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as Decimal,amountPaid: null == amountPaid ? _self.amountPaid : amountPaid // ignore: cast_nullable_to_non_nullable
as Decimal,amountDue: null == amountDue ? _self.amountDue : amountDue // ignore: cast_nullable_to_non_nullable
as Decimal,refundAmount: freezed == refundAmount ? _self.refundAmount : refundAmount // ignore: cast_nullable_to_non_nullable
as Decimal?,lastRefundAt: freezed == lastRefundAt ? _self.lastRefundAt : lastRefundAt // ignore: cast_nullable_to_non_nullable
as DateTime?,shopNameSnapshot: freezed == shopNameSnapshot ? _self.shopNameSnapshot : shopNameSnapshot // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String shopId,  String? customerId,  CustomerModel? customer,  String invoiceNumber,  String status, @DecimalConverter()  Decimal totalAmount, @DecimalConverter()  Decimal discountAmount, @DecimalConverter()  Decimal taxAmount, @DecimalConverter()  Decimal netAmount, @DecimalConverter()  Decimal amountPaid, @DecimalConverter()  Decimal amountDue, @DecimalConverter()  Decimal? refundAmount,  DateTime? lastRefundAt,  String? shopNameSnapshot,  String? shopAddressSnapshot,  String? shopPhoneSnapshot,  List<SaleItemModel> items,  List<PaymentModel> payments,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleModel() when $default != null:
return $default(_that.id,_that.shopId,_that.customerId,_that.customer,_that.invoiceNumber,_that.status,_that.totalAmount,_that.discountAmount,_that.taxAmount,_that.netAmount,_that.amountPaid,_that.amountDue,_that.refundAmount,_that.lastRefundAt,_that.shopNameSnapshot,_that.shopAddressSnapshot,_that.shopPhoneSnapshot,_that.items,_that.payments,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String shopId,  String? customerId,  CustomerModel? customer,  String invoiceNumber,  String status, @DecimalConverter()  Decimal totalAmount, @DecimalConverter()  Decimal discountAmount, @DecimalConverter()  Decimal taxAmount, @DecimalConverter()  Decimal netAmount, @DecimalConverter()  Decimal amountPaid, @DecimalConverter()  Decimal amountDue, @DecimalConverter()  Decimal? refundAmount,  DateTime? lastRefundAt,  String? shopNameSnapshot,  String? shopAddressSnapshot,  String? shopPhoneSnapshot,  List<SaleItemModel> items,  List<PaymentModel> payments,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _SaleModel():
return $default(_that.id,_that.shopId,_that.customerId,_that.customer,_that.invoiceNumber,_that.status,_that.totalAmount,_that.discountAmount,_that.taxAmount,_that.netAmount,_that.amountPaid,_that.amountDue,_that.refundAmount,_that.lastRefundAt,_that.shopNameSnapshot,_that.shopAddressSnapshot,_that.shopPhoneSnapshot,_that.items,_that.payments,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String shopId,  String? customerId,  CustomerModel? customer,  String invoiceNumber,  String status, @DecimalConverter()  Decimal totalAmount, @DecimalConverter()  Decimal discountAmount, @DecimalConverter()  Decimal taxAmount, @DecimalConverter()  Decimal netAmount, @DecimalConverter()  Decimal amountPaid, @DecimalConverter()  Decimal amountDue, @DecimalConverter()  Decimal? refundAmount,  DateTime? lastRefundAt,  String? shopNameSnapshot,  String? shopAddressSnapshot,  String? shopPhoneSnapshot,  List<SaleItemModel> items,  List<PaymentModel> payments,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _SaleModel() when $default != null:
return $default(_that.id,_that.shopId,_that.customerId,_that.customer,_that.invoiceNumber,_that.status,_that.totalAmount,_that.discountAmount,_that.taxAmount,_that.netAmount,_that.amountPaid,_that.amountDue,_that.refundAmount,_that.lastRefundAt,_that.shopNameSnapshot,_that.shopAddressSnapshot,_that.shopPhoneSnapshot,_that.items,_that.payments,_that.createdAt);case _:
  return null;
...
class _SaleModel implements SaleModel {
  const _SaleModel({required this.id, required this.shopId, this.customerId, this.customer, required this.invoiceNumber, required this.status, @DecimalConverter() required this.totalAmount, @DecimalConverter() required this.discountAmount, @DecimalConverter() required this.taxAmount, @DecimalConverter() required this.netAmount, @DecimalConverter() required this.amountPaid, @DecimalConverter() required this.amountDue, @DecimalConverter() this.refundAmount, this.lastRefundAt, this.shopNameSnapshot, this.shopAddressSnapshot, this.shopPhoneSnapshot, final  List<SaleItemModel> items = const [], final  List<PaymentModel> payments = const [], this.createdAt}): _items = items,_payments = payments;
...
@override final  String status;
@override@DecimalConverter() final  Decimal totalAmount;
...
@override@DecimalConverter() final  Decimal amountPaid;
@override@DecimalConverter() final  Decimal amountDue;
@override@DecimalConverter() final  Decimal? refundAmount;
@override final  DateTime? lastRefundAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,shopId,customerId,customer,invoiceNumber,status,totalAmount,discountAmount,taxAmount,netAmount,amountPaid,amountDue,refundAmount,lastRefundAt,shopNameSnapshot,shopAddressSnapshot,shopPhoneSnapshot,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_payments),createdAt]);
